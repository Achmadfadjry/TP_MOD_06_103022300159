...
namespace tpmod_06_103022300159
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            SayaTubeVideo videos = new SayaTubeVideo("Tutorial Design By Contract - Achmad fadjry adlil faqih");
            for (int i = 0; i < 3; i++)
            {
            ...
            try
            {
                SayaTubeVideo video = new SayaTubeVideo("Tutorial Design By Contract - Achmad fadjry adlil faqih");
